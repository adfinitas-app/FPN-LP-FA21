...
<section class='px-64 grid grid-cols-2'>
	<img src='/photo-header.png' alt='Image' />
	<div class='text-white text-center my-14'>
		<PlaceholderWithCorner>
			<h1 class='text-6xl font-extrabold'>
				<span class='text-7xl'>30 jours</span> pour faire
				place aux personnes en situation de handicap
			</h1>
		</PlaceholderWithCorner>
		<p class='text-2xl italic mt-10 font-bold'>
